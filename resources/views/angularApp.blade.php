...
<html ng-app='cicloviasApp'>
  <head>
    ...
    <script src="{{ URL::asset('js/CicloviasApp/components/map/ol3-popup.js') }}"></script>
    <link rel="stylesheet" type="text/css" href="{{ URL::asset('js/CicloviasApp/components/map/ol3-popup.css') }}">
